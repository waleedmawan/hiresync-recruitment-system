...
async function sendOTPEmail(toEmail, toName, otp) {
  await transporter.sendMail({
    from: `"RecruitIQ" <${process.env.MAIL_USER}>`,
    to: toEmail,
    subject: 'Verify your RecruitIQ account',
    html: `
      <div style="font-family:Arial,sans-serif; max-width:480px; margin:0 auto; background:#0f1117; color:#e2e8f0; padding:32px; border-radius:12px;">
        <h2 style="font-size:1.4rem; margin-bottom:8px; color:#ffffff;">Welcome to RecruitIQ 👋</h2>
        ...
        <p style="color:#64748b; font-size:0.78rem;">If you did not create a RecruitIQ account, you can safely ignore this email.</p>
      </div>
    `,
  });
}
